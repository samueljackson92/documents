...
The instrument parameters used in the reduction are defined in files called \seqsplit{ \textit{\textless instrument\_name\textgreater}\_diffraction\_diff\_spec\_Parameters.xml} and \seqsplit{ \textit{\textless instrument\_name\textgreater}\_diffraction\_diff\_only\_Parameters.xml} (if the instrument supports diff only mode).
